<nav class="sidebar">
    ...
    <ul>
        ...
        <li><a href="/ADMIN-SITE/order.php" class="myLink"><span class="material-symbols-outlined">assignment</span>Order</a></li>
        <li><a href="/ADMIN-SITE/analytics.php" class="myLink"><span
